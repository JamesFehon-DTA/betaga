...
<li class="ct-item-list__item">        <a class="ct-link ct-theme-light     ct-breadcrumb__links__link" href="/" data-component-id="dta_civic:link"><svg class="ct-icon  ct-link__icon" aria-hidden="true" role="img" data-component-id="dta_civic:icon" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

...
title: 'Adoption of Artificial Intelligence in the Public Sector'
description: 'On 1 September 2024, the Policy for the responsible use of AI in government took effect. This supersedes the below guidance, which is retired effective that same date.'
url: '/resource/adoption-of-artificial-intelligence-in-the-public-sector'
aga_code: 'DES167'
type: 'Design'
category: ''
---
...
On 1 September 2024, the [Policy for the responsible use of AI in government](https://architecture.digital.gov.au/responsible-use-of-AI-in-government) took effect. This supersedes the below guidance, which is retired effective that same date.
...
* broader reputational risks that apply to public trust in government services; further information on this aspect is described in the [Australian Data Strategy](https://ausdatastrategy.pmc.gov.au/)
...
* The [NSW AI Assurance Framework](https://www.digital.nsw.gov.au/policy/artificial-intelligence/nsw-ai-assurance-framework) is designed to assist agencies to design, build and use AI-enabled products and solutions. It is designed to help agencies identify risks that may be associated with their projects.
* New Zealand has the [Algorithmic Charter for Aotearoa New Zealand](https://data.govt.nz/assets/data-ethics/algorithm/Algorithm-Charter-2020_Final-English-1.pdf) that provides Charter signatories with a Risk Matrix to make an assessment of their algorithm decisions. This supports their evaluation, by quantifying the likelihood of an unintended adverse outcomes against its relative level of impact to derive an overall level of risk.
* Canada has the [Directive on Automated Decision Making](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=32592), that imposes a number of requirements, primarily related to risk management, on the federal government’s use of automated decision systems. This Directive is targeted at instances where artificial intelligence is used to make, or assist in making, administrative decisions.
...
At a whole of economy level, [Australia’s AI Ethics Principles](https://www.industry.gov.au/data-and-publications/australias-artificial-intelligence-ethics-framework/australias-ai-ethics-principles) released in 2019 are designed to ensure AI is safe, secure and reliable, as part of Australia’s broader [AI Ethics Framework](https://www.industry.gov.au/data-and-publications/australias-artificial-intelligence-ethics-framework). It was developed alongside several existing and emerging initiatives, including the [OECD Principles on AI](https://www.oecd.org/digital/artificial-intelligence/) which were endorsed by 42 countries, including Australia, and adopted by the G20. Australia’s eight AI Ethics Principles were codeveloped by CSIRO’s Data61 and the Department of Industry, Science and Energy (DISR), and help to:
...
The implementation of the AI Ethics Principles is a direct measure under the [Australia’s AI Action Plan](https://www.industry.gov.au/publications/australias-artificial-intelligence-action-plan) for making Australia a global leader in responsible and inclusive AI. The below guidance has been developed to assist agencies in the key considerations for applying these principles in a public sector context.
...
* [Australia’s anti-discrimination law](https://www.ag.gov.au/rights-and-protections/human-rights-and-anti-discrimination/australias-anti-discrimination-law) (Attorney-General’s Department) and the [human rights public sector guidance sheets](https://www.ag.gov.au/rights-and-protections/human-rights-and-anti-discrimination/human-rights-scrutiny/public-sector-guidance-sheets) (Attorney-General’s Department) provide additional information regarding discrimination. How user needs and their context for using a service will be understood and designed for as outlined in the [Digital Service Standard](https://www.dta.gov.au/help-and-advice/about-digital-service-standard) (Digital Transformation Agency).
...
* how [Disability discrimination](https://humanrights.gov.au/our-work/disability-rights/brief-guide-disability-discrimination-act) (Attorney General’s Department and the Australian Human Rights Commission) will be addressed, and the use of assistive technology to assist people with hearing, visual and other impairments to engage with the AI systems. It is worth noting that failing to provide a reasonable adjustment to enable a person with a disability to engage with AI may constitute unlawful discrimination under federal law
...
* how the application of AI technologies aligns with existing legal requirements that currently apply to government decision-making. These legal and policy requirements may include:
  + Privacy Act 1988 (Cth). Australian Government agencies subject to the *Privacy Act 1988* are required to conduct a privacy impact assessment (PIA) for all ‘high privacy risk projects’ under the [*Privacy (Australian Government Agencies – Governance) APP Code 2017*](https://www.oaic.gov.au/privacy/privacy-registers/privacy-codes-register/australian-government-agencies-privacy-code).
...
* [Automated Decision-making Better Practice Guide](https://www.ombudsman.gov.au/__data/assets/pdf_file/0030/109596/OMB1188-Automated-Decision-Making-Report_Final-A1898885.pdf) (The Commonwealth Ombudsman) provides a practical tool for agencies and includes a checklist designed to assist managers and project officers during the design and implementation of new automated systems in administrative decision-making, and with ongoing assurance processes once a system is operational.
* [Protective Security Policy Framework (PSPF)](https://www.protectivesecurity.gov.au/) Policy 8: Sensitive and classified information (Attorney-General’s Department).
* [Privacy Impact Assessment](https://www.oaic.gov.au/privacy/guidance-and-advice/guide-to-undertaking-privacy-impact-assessments) (Office of the Australian Information Commissioner).
* [NSW AI Assurance Framework](https://www.digital.nsw.gov.au/policy/artificial-intelligence/nsw-ai-assurance-framework)
* [Algorithmic Charter for Aotearoa New Zealand](https://data.govt.nz/assets/data-ethics/algorithm/Algorithm-Charter-2020_Final-English-1.pdf)

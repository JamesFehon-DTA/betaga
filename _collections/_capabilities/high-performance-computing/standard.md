...
3. **Australia’s research competitiveness**
...
2. Commonwealth-funded HPC facilities in the research environment, including:

* the [CSIRO’s Commonwealth owned and operated facilities and National Collaborative Research Infrastructure Strategy (NCRIS) funded research facilities](https://www.csiro.au/en/about/facilities-collections/pawsey-supercomputing-research-centre)
* the [Australian National University’s (ANU’s) National Computing Infrastructure (NCI)](https://science.anu.edu.au/research/facilities/national-computational-infrastructure), including ‘Gadi’ and other supercomputing facilities
* several ‘tier 2’ supercomputing research facilities, owned and operated by universities that are not Commonwealth entities, but available through various access schemes.

3. Whole-of-Government procurement arrangements with industry, including:

* DTA-administered [ICT procurement marketplaces and whole-of-government contract arrangements](https://www.buyict.gov.au/sp), including both cloud-oriented and on-premises HPC products and services.
...
* if utilising cloud providers for HPC functionality, procure via [BuyICT](https://www.buyict.gov.au/sp?id=marketplace_landing&marketplace=20d4561edb261c106529773c349619b7&kb=KB0010616&path=buying) and the whole-of-government contracts.

## Align to guidelines and standards

Entities must:

* comply with the [Hosting Certification Framework](https://architecture.digital.gov.au/hosting-certification-framework) to ensure cloud-oriented HPC services are hosted in certified tenancies/data centres
* apply the principles and requirements of the [Protective Security Policy Framework](https://architecture.digital.gov.au/protective-security-policy-framework-pspf) throughout their organisation, including in the context of High Performance Computing.

Entities should:

* apply a risk-based approach to cyber security, where it comes to HPC facilities, to align with the [Information Security Manual](https://www.cyber.gov.au/resources-business-and-government/essential-cyber-security/ism) (ISM).

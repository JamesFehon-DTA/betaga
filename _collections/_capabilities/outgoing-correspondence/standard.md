...
* align to applicable principles from the [Digital Experience Policy](https://architecture.digital.gov.au/digital-experience-policy), in particular to design and deliver services that are user-friendly, and inclusive, as well as relevant positions from the [Digital Service Standard](https://architecture.digital.gov.au/digital-service-standard-v2) and [Digital Inclusion Standard](https://architecture.digital.gov.au/digital-inclusion-standard)
...
* ensure cohesion between digital channels and outgoing correspondence
...
* ensure that each stage of the communication chain, between sender and recipient, meets legislative requirements and security standards such as the [Protective Security Policy Framework](https://architecture.digital.gov.au/protective-security-policy-framework-pspf).

Entities should:

* utilise an identity system to determine trust between individuals, organisations, services, and devices
* utilise the [Trusted Digital Identity Framework](https://architecture.digital.gov.au/trusted-digital-identity-framework-tdif-0) Identity Exchange and Attribute Provider to enable identity authentication
...
* comply with the [Policy for responsible use of AI in government](https://architecture.digital.gov.au/responsible-use-of-AI-in-government) where there is AI involved at any point in outgoing correspondence.
...
* apply [Australia’s 8 Artificial Intelligence (AI) Ethics Principles](https://www.industry.gov.au/publications/australias-artificial-intelligence-ethics-framework/australias-ai-ethics-principles) when curating and sending outgoing correspondences for people and businesses using AI

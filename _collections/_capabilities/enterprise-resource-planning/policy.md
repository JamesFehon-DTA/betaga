...
The DTA has a repository of artefacts developed by the Commonwealth that can be accessed by entities to help identify reuse opportunities. Contact [architecture@dta.gov.au](mailto:architecture@dta.gov.au) to request access.

...
parent_path: 'enterprise-resource-planning-travel-and-expense-management-system'
...
This standard is limited to the TEMS sub-capability, and should be viewed within the context of the overarching [Enterprise Resource Planning (ERP) Standard](https://architecture.digital.gov.au/enterprise-resource-planning-standard), and alongside those aligned to the other defined ERP value streams:

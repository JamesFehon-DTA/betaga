...
parent_path: 'australian-government-locator-service-metadata'
title: 'Australian Government Locator Service (AGLS) Metadata'
url: '/'
toc: 'toc-util'
content_top: true
aga_code: 'STA29'
...
The National Archives no longer has responsibility for AS 5044-2010, but provided advice on [metadata for the web](https://www.naa.gov.au/node/3386) and a [case study on Geoscience Australia](https://www.naa.gov.au/node/3388) to assist agencies in the post-AGLS environment.

## Access the standard

Standards Australia hosts archived copies of the [AGLS Metadata Standard](https://www.standards.org.au/search-results?query=AS5044%3A%202010) (full text).
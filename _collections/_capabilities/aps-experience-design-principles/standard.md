...
![An image listing the seven principles, with an icon for each principle: Simple, Inclusive, Tailored, Connected, Transparent, Safe, and Trustworthy.](https://architecture.digital.gov.au/sites/default/files/2025-01/Digital_Experience_Principles.png)

The principles are evidence-based, developed through extensive consultation, user research and review of best practice.
...
The principles are designed to work hand in hand with the [Digital Service Standard](https://www.digital.gov.au/policy/digital-experience/digital-service-standard), within the [Digital Experience Policy](https://www.digital.gov.au/policy/digital-experience).

They were developed as part of the [APS Reform Agenda](https://www.apsreform.gov.au/) to deliver better outcomes for the community and contribute to a fairer, more inclusive Australia. They also build on the [APS Vision for User-Centred Service Excellence](https://www.apsreform.gov.au/news/aps-vision-user-centred-service-excellence): ‘Reliable and accessible services, when and how you need them’.
...
They are endorsed by the executive [Partnership Priorities Committee](https://www.dss.gov.au/committees/resource/partnership-priorities-committee-communique-5-september-2024) for use by non-corporate Commonwealth entities. They apply to both new and existing services for staff and the public.
...
Commonwealth entities are supported in understanding and implementing the APS experience design principles by the [APS Experience Design Principles Handbook](https://architecture.digital.gov.au/design/aps-experience-design-principles-handbook).

If you would like more information about the principles or implementation strategies, please contact [cxstandard@servicesaustralia.gov.au](mailto:cxstandard@servicesaustralia.gov.au).
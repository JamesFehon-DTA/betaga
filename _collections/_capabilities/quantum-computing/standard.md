...
* apply the principles and requirements of the [Protective Security Policy Framework](https://architecture.digital.gov.au/protective-security-policy-framework-pspf) throughout their organisation, including in the context of quantum computing
* not violate the [Department of Defence’s export controls](https://www.defence.gov.au/business-industry/exporting/export-controls-framework) on quantum computing technology (as a regulated dual-use technology on the Defence and Strategic Goods List).
...
* align to the [National Quantum Strategy](https://www.industry.gov.au/publications/national-quantum-strategy/quantum-technologies), which forecasts the evolution of a range of quantum specific functions over the next 20+ years.

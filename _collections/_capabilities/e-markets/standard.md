...
The [*Digital service standard v2.0*](https://www.digital.gov.au/policy/digital-experience/digital-service-standard) is a set of best-practice principles to help entities design and build digital services that are simple, clear, and fast. Following the *Digital service standard* ensures digital services provide public value and meet user needs, with ongoing service improvements based on evidence and learnings.
...
Relevant identity exchange/attribute provider accreditation standard models that should be considered in e-markets design include the [*Australian Government digital ID system (AGDIS)*](https://architecture.digital.gov.au/design/agdis).
...
The Australian Signals Directorate produces the [*Information security manual* (ISM)](https://www.cyber.gov.au/resources-business-and-government/essential-cyber-security/ism). The purpose of the ISM is to outline a cyber security framework that entities can apply to protect their systems, including those related to e-markets, and associated data from cyber threats. Details in the ISM can be accessed here: [*Information security manual (ISM)*](https://www.cyber.gov.au/resources-business-and-government/essential-cyber-security/ism).
...
* [Fair trading laws](https://business.gov.au/legal/fair-trading/fair-trading-laws)
* The [Australian Consumer Law and your business](https://business.gov.au/legal/fair-trading/australian-consumer-law-and-your-business)
* The [Competition and Consumer Act](https://www.accc.gov.au/publications/small-business-the-competition-and-consumer-act)
* [Australian standards](https://www.productsafety.gov.au/product-safety-laws/safety-standards-bans/mandatory-standards/about-mandatory-standards)
* [Codes of conduct](https://business.gov.au/legal/fair-trading/codes-of-conduct).

When selling products or services, businesses need to understand and be compliant with:

* [Australia's trade measurement laws](https://business.gov.au/legal/fair-trading/australian-trade-measurement-laws)
* [Displaying prices](https://business.gov.au/legal/fair-trading/display-prices)
* [Product labelling](https://business.gov.au/products-and-services/product-labelling)
* [Secure card payments](https://business.gov.au/finance/payments-and-invoicing/choose-payment-methods)
* [Warranties and refunds](https://www.accc.gov.au/consumers/consumer-rights-guarantees/warranties).
...
* must comply with [Australian mandatory safety standards](https://www.productsafety.gov.au/product-safety-laws/safety-standards-bans/mandatory-standards)
* must not s[upply banned products](https://www.productsafety.gov.au/product-safety-laws/safety-standards-bans/product-bans)
* must [report the death or serious injury or illness](https://www.productsafety.gov.au/product-safety-laws/legislation/mandatory-reporting) of a person that occurred as a result of a consumer product supplied by the vendor
* should immediately [recall a product](https://www.productsafety.gov.au/recalls/conducting-a-consumer-product-safety-recall) if it may present a safety hazard, does not comply with a safety standard, or is banned – and notify the Australian Commonwealth Minister responsible
* must comply with any recall notices issued under the [Australian Consumer Law](https://www.productsafety.gov.au/product-safety-laws/legislation/australian-consumer-law)
...
For additional information see: [*Information asset management*](https://architecture.digital.gov.au/information-management) and [*Privacy protection*](https://architecture.digital.gov.au/capability/privacy-protection).
